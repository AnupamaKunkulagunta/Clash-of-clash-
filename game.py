...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops, spawnS_Archer,move_s_archers, move_healers, spawnHealers
...
while(True):
    ...
    move_s_archers(V,pt.movement, King)
    move_dragons(V)
    move_balloons(V)
    move_healers(King)
